<#
.SYNOPSIS
    This Azure Automation Runbook imports a module and all of it's dependencies into AA runtime environment from PowerShell Gallery.
...
$RunbookName = "Import-PSGalleryModuleAArte"
